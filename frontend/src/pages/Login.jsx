    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">NexusIMS</h1>
          <p className="text-gray-400 text-center">Sign in to manage your inventory and operations.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-black/20 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all"
        ...
        <div className="mt-8 pt-6 border-t border-white/10">
          ...
          <div className="flex justify-center gap-3">
            <button
              ...
              className="px-3 py-2 text-xs font-medium bg-white/5 hover:bg-white/10 text-gray-300 rounded-lg border border-white/10 flex items-center gap-2 transition-colors"
            >
