    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button className="flex items-center justify-center gap-2 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 hover:bg-black/10 dark:hover:bg-white/10 text-gray-900 dark:text-white font-medium py-2.5 px-5 rounded-xl transition-all">
            <RefreshCcw className="w-5 h-5" />
            Sync
          </button>
          <button className="flex items-center justify-center gap-2 bg-red-500/10 dark:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-500/20 dark:border-red-500/30 hover:bg-red-500/20 dark:hover:bg-red-500/30 font-medium py-2.5 px-5 rounded-xl transition-all">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-black/5 dark:divide-white/5">
              {movements.map((mov) => (
                <tr key={mov.id} className="text-gray-600 dark:text-gray-300 hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-4 px-6 font-medium text-gray-900 dark:text-white">{mov.product}</td>
                  ...
                  <td className="py-4 px-6 text-sm text-gray-500 dark:text-gray-400">{mov.date}</td>
