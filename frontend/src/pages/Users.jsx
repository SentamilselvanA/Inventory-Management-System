          ...
          <div key={u.id} className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:border-primary/50 transition-colors">
            ...
            <div className="flex items-start justify-between mb-6 relative z-10">
              ...
              <div className="flex gap-2">
                <button className="p-2 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                  <Settings className="w-4 h-4" />
                </button>
                {u.role !== 'admin' && (
                  <button className="p-2 bg-red-500/10 hover:bg-red-500/20 rounded-lg text-red-600 dark:text-red-400 transition-colors">
            ...
            <div className="flex items-center justify-between border-t border-black/10 dark:border-white/10 pt-4 relative z-10">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">{u.status}</span>
              </div>
            </div>
          </div>
        ))}
